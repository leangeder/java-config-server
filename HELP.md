...
* The original package name 'uk.co.underwriteme.ruleengine.config-server' is invalid and this project uses 'uk.co.underwriteme.ruleengine.configserver' instead.
